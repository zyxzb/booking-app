...
const Hotel = () => {
    ...
    const photos = [
        ...
        {
            src: 'https://images.unsplash.com/photo-1628592102751-ba83b0314276?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1697&q=80' }, 
        {
                ...
                <div className='hotelWrapper'>
                    ...
                    <div className="hotelDetails">
                        <div className="hotelDetailsText">
                            <h3>Opis Hotelu</h3>
                            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Doloribus debitis harum sunt repellendus sed et non ullam ab blanditiis nisi consectetur, incidunt alias, exercitationem reiciendis id explicabo maiores ipsum illum quod? Architecto quia, unde deleniti velit itaque saepe corrupti sapiente, delectus, illo quibusdam repellat quisquam. Consectetur, dolorem eos omnis vitae, quae optio nihil officiis pariatur dolore ex consequatur deserunt at rem laudantium numquam quisquam, sed a distinctio temporibus ipsum molestias. Numquam eius molestias sunt maiores explicabo amet vitae nulla velit sit doloremque quisquam, aut atque hic architecto, odio vel obcaecati nostrum laboriosam? Obcaecati, mollitia cum nisi deserunt necessitatibus odio adipisci!</p>
                        </div>
                        <div className="hotelDetailsPrice">
                            <h3>Idealny na 7 dni pobytu!</h3>
                            <span>Podsumowanie opisu - Lorem, ipsum dolor sit amet consectetur adipisicing elit. Architecto.</span>
                            <h4><b>900zł</b> <small>(7 dni)</small> </h4>
